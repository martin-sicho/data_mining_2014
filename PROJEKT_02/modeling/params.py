...
KERNEL = 'poly' # possible values: 'linear', 'poly', 'rbf', 'sigmoid', 'precomputed' or a callable
                  # (more at http://scikit-learn.org/stable/modules/svm.html#svm-kernels0)
DEGREE = 1 # only significant in poly, rbf, sigmoid
GAMMA = 0.0 # kernel coefficient for rbf and poly, if gamma is 0.0 then 1/n_features will be taken
COEF0 = 1 # independent term in kernel function. It is only significant in poly/sigmoid
